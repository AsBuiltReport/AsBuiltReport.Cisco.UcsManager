...
When contributing to this repository, please first discuss the change you wish to make via [issue](https://github.com/AsBuiltReport/AsBuiltReport.Cisco.UcsManager/issues), or [direct message](https://powershell.slack.com/messages/D3MU9DP8S) in the [PowerShell Slack](https://powershell.slack.com) channel before making a change.
...
1. Fork this repository (AsBuiltReport.Cisco.UcsManager), or if you are developing a report, fork the specific report repository. The example below uses the main AsBuiltReport.Cisco.UcsManager repository in the command examples.
2. Add `https://github.com/AsBuiltReport/AsBuiltReport.Cisco.UcsManager.git` as a remote named `upstream`.
    - `git remote add upstream https://github.com/AsBuiltReport/AsBuiltReport.Cisco.UcsManager.git`
...
[GitHub issues](https://github.com/AsBuiltReport/AsBuiltReport.Cisco.UcsManager/issues) is used to track issues and bugs. Report a bug by opening a new issue, it's that easy!
