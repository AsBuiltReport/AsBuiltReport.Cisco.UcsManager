...
@{
    ...
    GUID = 'b2ec5557-b6b5-4127-b78e-7621ccb16b36'
    ...
    Description = 'A PowerShell module to generate an as built report on the configuration of Cisco UCS Manager.'
    ...
    PrivateData = @{
        ...
        PSData = @{
            ...
            Tags = 'AsBuiltReport', 'Report', 'Cisco', 'UCS', 'Documentation', 'PScribo', 'PSEdition_Desktop', 'Windows'

            # A URL to the license for this module.
            LicenseUri = 'https://raw.githubusercontent.com/AsBuiltReport/AsBuiltReport.Cisco.UcsManager/master/LICENSE'
